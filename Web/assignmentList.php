...
<?php } else {
    ...
    <table class="blueone">
		...
		<?php foreach($assignment_list as $ass) { ?>
            <tr> <td>[<?php echo $ass['week']; ?>]</td> <td><a href="stdAssignment.php?ass_id=<?php echo $ass['ass_number']; ?>" class="no-uline"><?php echo $ass['title']; ?></a></td> <td><?php echo date("Y-m-d\TH:i:s", $ass['deadline']); ?></td> </tr>
		<?php } ?>
        <!-- Test Data
