...
- Compile Server
  - 서버 셋팅 : 원격 컴퓨터 이용 - UBUNTU LTS 18.04 (완료 16:00)
  - 파일을 수신하여 학번.c로 저장 : 소켓 통신
  - 파일 컴파일
    - 실패 : 컴파일 에러 결과 메시지를 학번.rs에 저장
    - 성공 : 파일 실행 결과를 학번rs에 저장
  - 파일을 웹 서버로 전송
- DB Server
  - 서버 셋팅 : MSAZURE 가상머신 이용 - UBUNTU LTS 16.04 (완료 16:00)
...
-> MariaDB 사용
3. README 작성은 main에서는 주된 내용만 간추려서 작성. 세부내용은 해당 directory의 README파일 이용
```
## 추후 보완 사항
